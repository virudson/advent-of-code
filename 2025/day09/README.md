...
the largest rectangle that uses red tiles for two of its opposite corners. They
...
Ultimately, the largest rectangle you can make in this example has area  `_50_`.
...
a straight line of  _green tiles_. The list wraps, so the first red tile is also
