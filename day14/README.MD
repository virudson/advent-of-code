...
massive  [parabolic reflector dish](https://en.wikipedia.org/wiki/Parabolic_reflector)
...
control panel on the side that lets you  _tilt_  it in one of four directions!
...
you need to calculate the  _total load_  on the north support beams
after  `1000000000`  cycles.

In the above example, after  `1000000000`  cycles, the total load on the north
support beams is  `_64_`.

Run the spin cycle for  `1000000000`  cycles. Afterward,  _what is the total
load on the north support beams?_
